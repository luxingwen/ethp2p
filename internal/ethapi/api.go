...
import (
	...
	"ethp2p/accounts"
	"ethp2p/accounts/abi"
	"ethp2p/accounts/keystore"
	"ethp2p/accounts/scwallet"
	"ethp2p/common"
	"ethp2p/common/hexutil"
	"ethp2p/common/math"
	"ethp2p/consensus/clique"
	"ethp2p/consensus/ethash"
	"ethp2p/consensus/misc"
	"ethp2p/core"
	"ethp2p/core/state"
	"ethp2p/core/types"
	"ethp2p/core/vm"
	"ethp2p/crypto"
	"ethp2p/eth/tracers/logger"
	"ethp2p/log"
	"ethp2p/p2p"
	"ethp2p/params"
	"ethp2p/rlp"
...
//
// https://ethp2p/wiki/Management-APIs#personal_sign
...
//
// https://ethp2p/wiki/Management-APIs#personal_ecRecover
